...
(def-doom-theme doom-laserwave
  ...
  ((lazy-highlight :background (doom-darken magenta 0.4) :foreground fg)
   ...
   (mode-line
    :background modeline-bg :foreground green
    :box (if -modeline-pad `(:line-width ,-modeline-pad :color ,modeline-bg)))
   (mode-line-inactive
    :background modeline-bg-inactive :foreground violet
   ...
   (doom-modeline-info :inherit 'yellow)
   (doom-modeline-urgent :inherit 'yellow)
   (doom-modeline-warning :inherit 'violet)
   (doom-modeline-debug :inherit 'green)
   (doom-modeline-buffer-minor-mode :inherit 'base6 :weight 'bold)
   (doom-modeline-project-dir :inherit 'base6 :weight 'bold)
   (doom-modeline-project-parent-dir :inherit 'blue :weight 'bold)
   (doom-modeline-persp-name :inherit 'pink :weight 'bold)
   (doom-modeline-buffer-file :inherit 'base6 :weight 'bold)
   (doom-modeline-buffer-modified :inherit 'orange :weight 'bold)
   (doom-modeline-lsp-success :inherit 'yellow :weight 'bold)
   (doom-modeline-buffer-path :inherit 'red :weight 'bold)
   (doom-modeline-buffer-project-root :inherit 'red)
